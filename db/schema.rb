...
ActiveRecord::Schema[7.2].define(version: 20_250_205_085_817) do
  ...
  create_table 'project_users', force: :cascade do |t|
    ...
    t.index %w[user_id project_id], name: 'index_project_users_on_user_id_and_project_id', unique: true
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[email role], name: 'index_users_on_email_and_role', unique: true
